...
let globalStorage = {}
console.log("The Extension 'Rock,Paper,Scissors' has started");
let rock = vscode.commands.registerCommand('Rock,Paper,Scissors.rock',async function () {
let funcName = "rock"; let pyVar = "python";
...
context.subscriptions.push(rock);
let paper = vscode.commands.registerCommand('Rock,Paper,Scissors.paper',async function () {
let funcName = "paper"; let pyVar = "python";
        let py = spawn(pyVar, [pythonPath, funcName]);
...
context.subscriptions.push(paper);
let scissors = vscode.commands.registerCommand('Rock,Paper,Scissors.scissors',async function () {
let funcName = "scissors"; let pyVar = "python";
        let py = spawn(pyVar, [pythonPath, funcName]);
...
context.subscriptions.push(scissors);
}
